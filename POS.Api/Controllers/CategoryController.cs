...
namespace POS.Api.Controllers
{
	...
	public class CategoryController : ControllerBase
	{
		...
		[HttpPost("Register")]
		public async Task<IActionResult> RegisterCategory([FromBody] CategoryRequestDtos requestDto)
		{
		...
		public async Task<IActionResult> EditCategory(int categoryId, [FromBody] CategoryRequestDtos requestDto)
		{
